...
echo -e "============================================="
sleep 2
wget https://raw.githubusercontent.com/jinGGo007/PRIVATE/main/V4/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
sleep 2
clear
...
echo -e "============================================="
sleep 2
wget https://raw.githubusercontent.com/jinGGo007/PRIVATE/main/V4/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
sleep 2
clear
...
echo "   - V2RAY Vless TLS         : 8000"  | tee -a log-install.txt
