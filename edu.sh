...
wget -q -O /usr/local/bin/edussh-nontls https://raw.githubusercontent.com/jinGGo007/SCRIPT/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/jinGGo007/SCRIPT//main/edu-op.py
