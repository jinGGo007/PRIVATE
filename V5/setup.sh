...
echo "   - XRAY VLESS XTLS SPLICE  : 80"  | tee -a log-install.txt
echo "   - XRAY VLESS XTLS DIRECT  : 80"  | tee -a log-install.txt
echo "   - XRAY VLESS WS TLS       : 80"  | tee -a log-install.txt
echo "   - XRAY TROJAN TLS         : 80"  | tee -a log-install.txt
echo "   - XRAY VMESS TLS          : 80"  | tee -a log-install.txt
echo "   - V2RAY VLESS TLS SPLICE  : 8000" | tee -a log-install.txt
echo "   - V2RAY VLESS TLS DIRECT  : 8000" | tee -a log-install.txt
echo "   - V2RAY VLESS WS TLS      : 8000" | tee -a log-install.txt
echo "   - V2RAY TROJAN TLS        : 8000" | tee -a log-install.txt
echo "   - V2RAY VMESS TLS         : 8000" | tee -a log-install.txt
